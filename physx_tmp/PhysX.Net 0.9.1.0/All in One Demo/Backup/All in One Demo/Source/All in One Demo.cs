...
namespace StillDesign
{
	...
	public class Notify : UserNotify
	{
		...
		public override bool OnJointBreak( float breakingForce, BaseJoint brokenJoint )
		{
			return true;
		}
	...
	public class TriggerReport : UserTriggerReport
	{
		...
		public override void OnTrigger( BaseShape triggerShape, BaseShape otherShape, TriggerFlag status )
		{
