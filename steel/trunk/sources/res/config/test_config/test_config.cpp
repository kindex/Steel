...
// Test incorrect structs
	...
	TEST_PARSER_INCORRECT("}", "struct");
	TEST_PARSER_INCORRECT("{)", "struct");
	TEST_PARSER_INCORRECT("{abc}", "struct");
	TEST_PARSER_INCORRECT("{123}", "struct");
	TEST_PARSER_INCORRECT("{ = 123}", "struct");
	TEST_PARSER_INCORRECT("{ 123 = 124}", "struct");
	TEST_PARSER_INCORRECT("{ abc = def}", "struct");
	TEST_PARSER_INCORRECT("{ abc = }", "struct");
	TEST_PARSER_INCORRECT("{ x = 2;; }", "struct");
	TEST_PARSER_INCORRECT("{ x = 2,, }", "struct");
	TEST_PARSER_INCORRECT("{ x = 2 x = 2 }", "struct");
	TEST_PARSER_INCORRECT("{ x = 2 x = 3 }", "struct");
	TEST_PARSER_INCORRECT("{ פûגא = 2 }", "struct");
