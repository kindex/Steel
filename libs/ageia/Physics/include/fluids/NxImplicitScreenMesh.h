...
/**
\brief Deprecated: The fast fluid surface mesh class is used to generate a fluid surface mesh or a
...
public:
	...
	/**
	\brief Deprecated: Sets particles which are used for this screen mesh generation.
	...
	*/
	...
	/**
	\brief Deprecated: Sets the user buffer wrapper for the mesh.
	...
	*/
	...
	/**
	\brief Deprecated: Returns a copy of the user buffer wrapper for the mesh.
  ...
  /**
	\brief Deprecated: Begin generation of a new surface
  ...
  /**
	\brief Deprecated: Copy mesh into buffers defined by NxMeshData
  ...
  /**
	\brief Deprecated: Checks whether surface generation has completed
	...
	*/
	...
	/**
	\brief Deprecated: Returns the spacing of the 2D map.
	...
	*/
	...
	/**
	\brief Deprecated: Sets the spacing of the 2D map.
	...
	*/
    ...
    /**
	\brief Deprecated: Returns the minimum density that generates a surface.
	...
	*/
	...
	/**
	\brief Deprecated: Sets the minimum density that generates a surface.
	...
	*/
	...
	/**
	\brief Deprecated: Gets the hierarchy level of the triangle mesh generation, currently existing in Software mode.	
	...
	*/
	...
	/**
	\brief Deprecated: Sets the hierarchy level of the triangle mesh generation, currently existing in Software mode.	
	...
	*/
	...
	/**
	\brief Deprecated: Returns the particles' radius.
	...
	*/
	...
	/**
	\brief Deprecated: Sets the particles' radius.
	...
	*/
	...
	/**
	\brief Deprecated: Returns the depth smoothing filter size.
	...
	*/
	...
	/**
	\brief Deprecated: Sets the depth smoothing filter size.
	...
	*/
	...
	/**
	\brief Deprecated: Returns the silhouette smoothing filter size.
	...
	*/
	...
	/**
	\brief Deprecated: Sets the silhouette smoothing filter size.
	...
	*/
	...
	/**
	\brief Deprecated: Sets the projection parameters.
	...
	*/
	...
	/**
	\brief Deprecated: Gets the projection parameters.
	...
	*/	
	...
	/**
	\brief Deprecated: Sets the triangle winding parameter.
	...
	*/
	...
	/**
	\brief Deprecated: Gets the triangle winding parameter.
	...
	*/
	...
	/**
	\brief Deprecated: Creates the triangles based on the input parameters.
	...
	*/
	...
	/**
	\brief Deprecated: Sets a name string for the object that can be retrieved with getName().  
	...
	*/
	...
	/**
	\brief Deprecated: Retrieves the name string set with setName().
