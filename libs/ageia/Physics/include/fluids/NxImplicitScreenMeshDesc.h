...
/**
\brief Deprecated: Specifies the parameters for screen mesh generation.
...
public:
	...
	/**
	\brief Deprecated: The spacing of the 2D map.
	...
	*/
	...
	/**
	\brief Deprecated: The hierarchy level used to control the resolution of mesh generated.
	...
	*/
	...
	/**
	\brief 	Deprecated: Specifies input particle's radius.
	...
	*/
	...
	/**
	\brief 	Deprecated: Specifies the minimum density that generates a surface.
	...
	*/
	...
	/**
	\brief Deprecated: Sets the viewport width from outside rendering.
	
	\warning <b>Preliminary API, subject to change</b>
	*/
	NxU32	width;
	/**
	\brief Deprecated: Sets the viewport height from outside rendering.
	...
	*/
	...
	/**
	\brief Deprecated: Sets the projection matrix from outside rendering.
...
M =	| 0  4  8  12 |
	...
	*/
	...
	/**
	\brief Deprecated: Sets the triangle winding to get a more regular triangulation.
	...
	*/
	...
	/**
	\brief Deprecated: Defines how the generated mesh is written to user mesh buffers.
	...
	*/
	...
	/**
	\brief Deprecated: (Re)sets the structure to the default.	
	...
	*/
	...
	/**
	\brief Deprecated: Returns true if the current settings are valid
	...
	*/
	...
	/**
	\brief Deprecated: Constructor sets to default.
